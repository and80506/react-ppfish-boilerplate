...
class StockSuggest extends Component {
  constructor(props) {
    super(props);
    let defaultState = {
      position: {
  ...
  handleInputChange(e) {
    ...
    // 搜索词变化时,强制显示搜索列表
    let panel = this.panelContainer.querySelector('.stock-suggest-panel');
    if (panel) {
  ...
  render() {
    ...
    return (
      <div className="stock-suggest-wrapper" style={style} ref="suggestInput">
